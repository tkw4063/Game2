...
def inventory(screen,rcount,scount,dcount):
    ...
    pygame.draw.rect(screen,(255,255,255),pygame.Rect(300,0,400,50))
    ...
    din, TextRect4 = text_objects("You've gained " + str(dcount) + " dinosaur followers!",font)
    TextRect1.center = ((940),(10))
    TextRect2.center = ((940),(35))
    TextRect3.center = ((940),(60))
    TextRect4.center = ((500),(25))
